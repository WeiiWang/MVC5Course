namespace MVC5Course.Models
{
	public static class RepositoryHelper
	{
		...
		public static Table_1Repository GetTable_1Repository()
		{
			var repository = new Table_1Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static Table_1Repository GetTable_1Repository(IUnitOfWork unitOfWork)
		{
			var repository = new Table_1Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
